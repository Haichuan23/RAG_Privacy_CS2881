...
class DataArguments:
    ...
    evaluation_mode: str = field(default=None)

# @dataclass
# class MyArguments:
#     task: str = field(default="io", metadata={"help": "Task to run: io | eval | debug"})
#     my_seed: int = field(default=42, metadata={"help": "Random seed for reproducibility"})
#     evaluation_mode: Literal["replicate", "benign", "robustness"] = field(
#         default="replicate",
#         metadata={"help": "Evaluation mode: replicate, benign, or robustness"}
#     )
